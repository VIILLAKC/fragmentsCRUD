...
public class actualizar extends Fragment  {
    ...
    EditText txtNombre, txtEditorial, txtCosto, txtid;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtid = (EditText) view.findViewById(R.id.idtxt);
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                long id =  DBmangas.actualizarComiscs(Integer.valueOf(txtid.getText().toString()) ,txtNombre.getText().toString(), txtEditorial.getText().toString(), txtCosto.getText().toString() );
